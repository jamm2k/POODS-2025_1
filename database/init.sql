...
CREATE TABLE itens (
	...
	tipo varchar(255) DEFAULT 'NORMAL'::character varying NOT NULL,
	categoria varchar(255) DEFAULT 'COMIDA'::character varying NOT NULL,
	CONSTRAINT itens_tipo_check CHECK (tipo IN ('NORMAL', 'PREMIUM')),
	CONSTRAINT itens_categoria_check CHECK (categoria IN ('COMIDA', 'BEBIDA', 'DRINK', 'SOBREMESA')),
